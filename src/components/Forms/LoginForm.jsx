...
export default function LoginForm({
  ...
  const fetchData = async () => {
    try {
      ...
      const videosResponse = await fetch(
        "https://cms-crvm.onrender.com/cms/getCMS"
      );
  ...
  const handleDelete = async (id, type) => {
    ...
    try {
      ...
      if (type === "video") {
        response = await fetch(
          "https://cms-crvm.onrender.com/cms/deleteYoutube",
          {
            method: "DELETE",
            headers: {
        ...
        response = await fetch(
          "https://cms-crvm.onrender.com/aws/deleteImage",
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
                ...
                {images.map((image, index) => (
                  <tr key={index}>
                    ...
                    <td className="border p-2">
                      <img src={image} alt="Uploaded" className="h-12 w-auto" />
                    </td>
                    <td className="border p-2 text-center">
                      <button
